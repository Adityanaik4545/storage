"use client"
import { avatarPlaceHolderUrl, navItems } from '@/constants/constant'
...
const Sidebar = ({fullName, email, avatar}:Props) => {
  ...
  return (
    <aside className='sidebar'>
      <Link href={"/"}>
      <Image src='/assets/icons/logo-full-brand.svg' alt='logo' width={160} height={50} className='h-auto hidden lg:block'/>
